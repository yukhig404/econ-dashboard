...
const INDICATORS = {
  NFP:{id:"PAYEMS",name:"雇用者数(NFP)",nameEn:"Nonfarm Payrolls",unit:"千人",color:"#E8453C",cat:"employment",freq:"月次",desc:"毎月第1金曜日発表。労働市場の最重要指標。",impact:"雇用増→利上げ圧力→ドル高",nextRel:"2026-03-06",relName:"雇用統計"},
  UNRATE:{id:"UNRATE",name:"失業率",nameEn:"Unemployment Rate",unit:"%",color:"#FF6B6B",cat:"employment",freq:"月次",desc:"労働力人口に対する失業者の割合。",impact:"失業率低下→経済好調→株高",nextRel:"2026-03-06",relName:"雇用統計"},
  ICSA:{id:"ICSA",name:"新規失業保険申請",nameEn:"Initial Claims",unit:"件",color:"#C0392B",cat:"employment",freq:"週次",desc:"毎週木曜発表。最も速報性の高い雇用指標。",impact:"申請増→雇用悪化→利下げ期待",nextRel:"2026-02-27",relName:"失業保険"},
  JOLTS:{id:"JTSJOL",name:"求人件数(JOLTS)",nameEn:"JOLTS Openings",unit:"千件",color:"#E74C3C",cat:"employment",freq:"月次",desc:"労働需要を示す。求人/失業者比率が重要。",impact:"求人増→労働需給タイト→賃金上昇圧力",nextRel:"2026-03-11",relName:"JOLTS"},
  CPI:{id:"CPIAUCSL",name:"CPI総合",nameEn:"CPI All Items",unit:"指数",color:"#F5A623",cat:"inflation",freq:"月次",desc:"消費者物価の総合指標。エネルギー・食品含む。",impact:"CPI上昇→利上げ期待→債券安",nextRel:"2026-03-12",relName:"CPI"},
  CORECPI:{id:"CPILFESL",name:"コアCPI",nameEn:"Core CPI",unit:"指数",color:"#F39C12",cat:"inflation",freq:"月次",desc:"食品・エネルギー除く。FRBが重視する物価指標。",impact:"コアCPI高止まり→利下げ遅延",nextRel:"2026-03-12",relName:"CPI"},
  FEDFUNDS:{id:"FEDFUNDS",name:"FF金利",nameEn:"Fed Funds Rate",unit:"%",color:"#4A90D9",cat:"policy",freq:"月次",desc:"FOMCが決定する政策金利。全市場に影響。",impact:"利上げ→株安圧力 / 利下げ→株高",nextRel:"2026-03-18",relName:"FOMC"},
  GDP:{id:"GDP",name:"GDP",nameEn:"GDP",unit:"十億$",color:"#7ED321",cat:"economy",freq:"四半期",desc:"経済成長の最も包括的な指標。",impact:"GDP成長→企業収益改善→株高",nextRel:"2026-03-26",relName:"GDP速報"},
  ISM:{id:"MANEMP",name:"ISM製造業",nameEn:"ISM Manufacturing",unit:"指数",color:"#1ABC9C",cat:"economy",freq:"月次",desc:"50超で製造業拡大。景気先行指標。",impact:"50超→製造業拡大→景気回復期待",nextRel:"2026-03-02",relName:"ISM"},
  RETAIL:{id:"RSAFS",name:"小売売上高",nameEn:"Retail Sales",unit:"百万$",color:"#2ECC71",cat:"economy",freq:"月次",desc:"個人消費の動向。GDPの約7割を占める消費を反映。",impact:"売上増→消費堅調→GDP押し上げ",nextRel:"2026-03-14",relName:"小売売上"},
  DGS10:{id:"DGS10",name:"10年国債利回り",nameEn:"10Y Treasury",unit:"%",color:"#3498DB",cat:"market",freq:"日次",desc:"長期金利の指標。住宅ローンや企業借入に影響。",impact:"利回り上昇→株バリュエーション低下",nextRel:"-",relName:"-"},
  DGS2:{id:"DGS2",name:"2年国債利回り",nameEn:"2Y Treasury",unit:"%",color:"#2980B9",cat:"market",freq:"日次",desc:"短期金利。FF金利の市場予想を反映。",impact:"2Y上昇→利上げ織り込み進行",nextRel:"-",relName:"-"},
  T10Y2Y:{id:"T10Y2Y",name:"イールドカーブ",nameEn:"10Y-2Y Spread",unit:"%",color:"#8E44AD",cat:"market",freq:"日次",desc:"逆イールド（マイナス）はリセッション予兆として有名。",impact:"逆転→リセッション警告→リスクオフ",nextRel:"-",relName:"-"},
  ...
  SP500:{id:"NASDAQCOM",name:"NASDAQ総合",nameEn:"NASDAQ Composite",unit:"指数",color:"#9B59B6",cat:"market",freq:"日次",desc:"NASDAQ上場全銘柄の時価総額加重指数。テック株の動向を反映。",impact:"主要指標の結果を最も直接的に反映",nextRel:"-",relName:"-"},
...
// ─── DEMO DATA ──────────────────────────────────────────────────────────
function genDemo(ind,years=15){const d=[];const now=new Date();const m=years*12;const isQ=ind==="GDP";const isD=["DGS10","DGS2","T10Y2Y","VIX","SP500","JP_USDJPY","BITCOIN"].includes(ind);const isW=ind==="ICSA";const step=isQ?3:1;const total=isD?years*252:m;
